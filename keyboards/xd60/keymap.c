...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_BASE] = KEYMAP(
    ...
    MO(_FUNC), XXXXXXX, KC_Z,    KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT,  KC_SLSH, MO(_FUNC),          KC_UP,   KC_DEL,  \
  ...
  [_FUNC] = KEYMAP(
    ...
    _______, XXXXXXX, KC_VOLD, KC_MUTE,  KC_VOLU, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______, KC_PGUP,   KC_INS, \
