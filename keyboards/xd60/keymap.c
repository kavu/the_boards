...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_BASE] = LAYOUT_ALL(
    ...
    MO(_FUNC), XXXXXXX, KC_Z,    KC_X,     KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, TG(_STEN), KC_UP,   KC_DEL,  \
  ...
  [_STEN] = LAYOUT_ALL(
    TG(_STEN), STN_N1,  STN_N2,  STN_N3,   STN_N4,  STN_N5,  STN_N6,  STN_N7,  STN_N8,  STN_N9,  STN_NA,  STN_NB,  STN_NC,  XXXXXXX,  XXXXXXX, \
