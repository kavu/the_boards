...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_BASE] = LAYOUT_all(
    ...
    MO(_FUNC), XXXXXXX, KC_Z,    KC_X,     KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, XXXXXXX, XXXXXXX, XXXXXXX, \
  ...
  [_FUNC] = LAYOUT_all(
    ...
    _______,   XXXXXXX, KC_VOLD, KC_MUTE,  KC_VOLU, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,   XXXXXXX, XXXXXXX,\
    _______,   _______, _______,                             KC_MPLY,                            _______, KC_HOME, KC_PGDOWN, KC_PGUP, KC_END),
  ...
  [_STEN] = LAYOUT_ALL(
    ...
    XXXXXXX,   XXXXXXX, XXXXXXX, STN_A,    STN_O,   XXXXXXX, XXXXXXX, STN_E,   STN_U,   STN_PWR, STN_RE1, STN_RE2, XXXXXXX, XXXXXXX,  XXXXXXX, \
    XXXXXXX,   XXXXXXX, XXXXXXX,                             KC_SPC,                             XXXXXXX, KC_LEFT, KC_DOWN, KC_UP,    KC_RIGHT),
  #endif
};
